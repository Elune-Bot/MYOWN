...
module.exports.run = async (CLOXY, message, args) => {
	...
	const embed = new Discord.RichEmbed()
		...
		.addBlankField(true)
		.addField('Humans', `**${message.guild.members.filter(member => !member.user.CLOXY).size}**`, true)
		.addField('Bots', `**${message.guild.members.filter(member => member.user.CLOXY).size}**`, true)
